            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  className={`w-full px-4 py-2 border ${fieldErrors.name ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent`}
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-2 border ${fieldErrors.email ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent`}
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-2 border ${fieldErrors.phone ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-2 border ${fieldErrors.age ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent`}
                  placeholder="25"
                />
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-2 border ${fieldErrors.height ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent`}
                  placeholder="175"
                />
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-2 border ${fieldErrors.weight ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent`}
                  placeholder="75"
                />
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-2 border ${fieldErrors.ideal_weight ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent`}
                  placeholder="70"
                />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-2 border ${fieldErrors.budget ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent`}
                  placeholder="70"
                />
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-2 border ${fieldErrors.prep_time ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent`}
                  placeholder="30"
                />
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Meal Variety <span className="text-red-500">*</span>
                </label>
                <select
